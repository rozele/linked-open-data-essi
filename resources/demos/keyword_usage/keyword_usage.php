...
if ( $meeting != '' ) {
  ...
  if ( $meeting == "2007_sm" ) { $mtg = "2007 Spring Meeting</option>"; }
  if ( $meeting == "2007_fm" ) { $mtg = "2007 Fall Meeting</option>"; }
  if ( $meeting == "2008_sm" ) { $mtg = "2008 Spring Meeting</option>"; }
  if ( $meeting == "2008_fm" ) { $mtg = "2008 Fall Meeting</option>"; }
  if ( $meeting == "2009_sm" ) { $mtg = "2009 Spring Meeting</option>"; }
  if ( $meeting == "2009_fm" ) { $mtg = "2009 Fall Meeting</option>"; }
  if ( $meeting == "2010_sm" ) { $mtg = "2010 Spring Meeting</option>"; }
  if ( $meeting == "2010_fm" ) { $mtg = "2010 Fall Meeting</option>"; }
