...
import essi.lod.abstracts.HtmlAbstract;
...
import essi.lod.data.source.AbstractDataSource;
...
{
	static final Logger log = Logger.getLogger(essi.lod.data.agu.AguSessionCrawler.class);  
	...
	{	
	    ...
	    {	
	    	...
	    	if (endpoint != null)
	    	{
	    		SparqlMatcher m = new SparqlMatcher(endpoint, graph);
