 ...
 */
package essi.lod.data.esip.rdf;
 ...
 * 
 */
public class EsipClusterParser extends DefaultHandler {
    ...
    public Vector <Cluster> parse ( String file ) throws Exception {
        ...
        EsipClusterParser handler = new EsipClusterParser();
    ...
    public EsipClusterParser() { super(); }
